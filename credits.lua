...
function newCredits()
	...
	obj.draw = function(self)
		...
		self.drawRainbowText("Meral Leyla (Sound)", 0, 80 + 48, 4)
		self.drawRainbowText("Nico Reitmeier (Sound)", 0, 80 + 72, 4)
		self.drawRainbowText("Nicola Robin (Art)", 0, 80 + 96, 2)
		self.drawRainbowText("Philip Braun (Code)", 0, 80 + 120, 3)
